...
{{- define "homework.containerName" -}}
{{- default .Chart.Name .Values.ContainerNameOverrideMain | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "homework.pv.accessModes" -}}
{{- default "ReadWriteOnce" .Values.volumes.spec.accessMode | trunc 63 | trimSuffix "-" }}
{{- end }}
